...
zone "K11.com" {
    ...
    allow-transfer { 10.69.4.5; }; // IP Amdir (Slave)
    notify yes;
};
EOF
...
options {
    ...
    allow-query { any; };
    allow-transfer { 10.69.4.5; }; // Amdir
    recursion yes;
    listen-on-v6 { none; };
...
nslookup ns1.K11.com 127.0.0.1
...
nslookup palantir.K11.com 10.69.4.5

# 3. Test semua A records
nslookup elros.K11.com
nslookup pharazon.K11.com
nslookup elendil.K11.com
nslookup galadriel.K11.com

# 4. Test NS records
nslookup -type=NS K11.com
